    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <?php if (have_posts()) : ?>
                ...
                ?>
                    <article <?php post_class('menu-item-card bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-all'); ?>>
                        ...
                        <div class="p-6">
                            <h2 class="text-xl font-bold mb-2 font-playfair text-irimas-blue">
                                <?php the_title(); ?>
                            </h2>
